SELECT
    f.MasterPatient_ID,
    NVL(k.ATCComorbCateg, '0') AS Cond_binary
FROM
    (   SELECT
            DISTINCT d.MasterPatient_ID,
            b.ATCComorbCateg
        FROM
            DimMAIU d
        CROSS JOIN
            (   SELECT
                    DISTINCT ATCComorbCateg,
                    MasterPatient_ID,
                ...
                FROM
                    (   SELECT
                        ...
                        ON
                            m.MAIU_ID = f.MAIUID
                        --WHERE DispenseCalendarDate BETWEEN add_months('2021-07-31', -24) AND '2021-07-31'
                        AND ATCComorbCateg <> '0'
                        AND MasterPatient_ID BETWEEN 200 AND 1000000
                        GROUP BY
                            MasterPatient_ID,
                            ATCComorbCateg,
                            ATCLevel5Code
                ...
                GROUP BY
                    ...
                    2) b
        --WHERE
            --d.MasterPatient_ID BETWEEN 200 AND 1000000
        ORDER BY
            MasterPatient_ID) f
LEFT JOIN
    (   SELECT
        ...
        FROM
            (   SELECT
                ...
                GROUP BY
                    ...
                    ATCLevel5Code
                ORDER BY
                    MasterPatient_ID) a) k
ON
    f.MasterPatient_ID = k.MAsterPatient_ID
AND f.ATCComorbCateg = k.ATCComorbCateg